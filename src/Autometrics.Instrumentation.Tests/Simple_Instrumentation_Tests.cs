...
{
    public class Simple_Instrumentation_Tests
    {
        ...
        public void Record_Late_Failing_Methods()
        {
            ...
            try
            {
                ...
                instrumentedMethods.SimpleMethod(exceptionBeforeSleep: false, sleepTimeMs: (int)(sleepDuration * 1000), exceptionAfterSleep: true);
            }
            catch
            {
            ...
            Assert.IsTrue(batch.LongReadings == 1, "No function call count was seen");
            Assert.IsTrue(batch.DoubleReadings == 1, "No duration reading was seen");

            Assert.IsTrue(batch.ValidateDuration(sleepDuration, .5), "The recorded duration was out of acceptable tollerance");

            Assert.IsTrue(batch.ValidateFunctionNames(new[] { "SimpleMethod" }), "One or more of the function name tags was incorrect");
            ...
            Assert.IsTrue(batch.ValidateCallers(new[] { "Record_Late_Failing_Methods" }), "One or more of the caller tags was incorrect");
        }
        ...
        public void Record_Early_Failing_Methods()
        {
            ...
            {
                // Call our sample method and tell it what to do
                instrumentedMethods.SimpleMethod(exceptionBeforeSleep: true, sleepTimeMs: (int)(sleepDuration * 1000), exceptionAfterSleep: true);
            }
            catch
            {
                // This was expected to throw an exception, but we should still get instrumentation.
            ...
            Assert.IsTrue(batch.ValidateModuleName("Autometrics.Instrumentation.Tests.InstrumentedMethods"), "One or more of the module name tags was incorrect");
            Assert.IsTrue(batch.ValidateResult("error"), "One or more of the result tags was incorrect");
            Assert.IsTrue(batch.ValidateCallers(new[] { "Record_Early_Failing_Methods" }), "One or more of the caller tags was incorrect");
        }
        ...
        public void Record_Fast_Sucessful_Methods()
        {
            ...
            Assert.IsTrue(batch.ValidateModuleName("Autometrics.Instrumentation.Tests.InstrumentedMethods"), "One or more of the module name tags was incorrect");
            Assert.IsTrue(batch.ValidateResult("error"), "One or more of the result tags was incorrect");
            Assert.IsTrue(batch.ValidateCallers(new[] { "Record_Fast_Sucessful_Methods" }), "One or more of the caller tags was incorrect");
        }
        ...
        public void Record_Slow_Sucessful_Methods()
        {
            ...
            Assert.IsTrue(batch.ValidateModuleName("Autometrics.Instrumentation.Tests.InstrumentedMethods"), "One or more of the module name tags was incorrect");
            Assert.IsTrue(batch.ValidateResult("error"), "One or more of the result tags was incorrect");
            Assert.IsTrue(batch.ValidateCallers(new[] { "Record_Slow_Sucessful_Methods" }), "One or more of the caller tags was incorrect");
        }
    }
}